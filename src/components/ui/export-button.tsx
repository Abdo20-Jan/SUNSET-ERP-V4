...
// Botón "Exportar" (Excel/CSV) para los maestros. Hereda los filtros/sort de la
// URL actual (q, marca/estado/pais, sort, dir) e IGNORA la paginación
// (page/perPage), de modo que el archivo trae TODAS las filas del set filtrado.
// El trabajo pesado vive en /api/export/[recurso] (server).
