...
const columns: ColumnDef<SerializedTreeNode>[] = [
  {
    id: "codigo",
    header: "Código",
    cell: ({ row }) => {
      ...
      <TableBody>
        ...
        {totalLabel && totalValue != null ? (
          <TableRow className="border-t-2 bg-muted/50 hover:bg-muted/50">
            <TableCell colSpan={4} className="py-3 font-semibold">
              {totalLabel}
            </TableCell>
...
/** Helper para serializar un CuentaTreeNode del service en un shape apto para Client Component. */
