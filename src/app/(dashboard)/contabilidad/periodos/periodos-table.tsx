...
function RowAction({
  ...
  return (
    <Tooltip>
      {/* biome-ignore lint/a11y/noNoninteractiveTabindex: wrapper focusable necesario para que el Tooltip dispare con teclado cuando el Button hijo está disabled */}
